...
void FLASH_ByteWrite(FLADDR addr, char byte, bit SFLE) {
  ...
  EA = 0; // dummy instruction with two-byte opcode. do not remove
...
void FLASH_PageErase(FLADDR addr, bit SFLE) {
  ...
  //TODO: This was added to fix ADCS watchdog reset during scratchpad page erase
  WDTCN = 0xDE;
